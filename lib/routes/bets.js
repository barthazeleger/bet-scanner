 ...
 *
 * NIET in scope (complex deps, extractie in eigen sprint):
 *   - POST   /api/bets (create, schema-fallback, snapshot writes, scan-gate)
 *   - PUT    /api/bets/:id (update outcome/odds/units met revert-calib)
 *   - POST   /api/bets/recalculate (admin bulk wl-recompute)
 *   - GET    /api/bets/:id/current-odds (fetchCurrentOdds api-football)
 *
 * @param {object} deps
